...
""",
    ...
    with paper_expander:
        ...
        pairplot = col1.button('Pair plot relationship (Age Features - Pregnancy Features)')
        heatmap = col1.button('Heatmap (Age - Maternal History)')
