...
def show_result(contraceptive_result):
    if contraceptive_result == "Basal Body temperature":
        ...
        st.markdown("<img src='/streamlit_deploy/tree/main/contraceptives/Pill/Pill.png' style='display: block; margin-left: auto; margin-right: auto; width: 50%;'>", unsafe_allow_html=True)
